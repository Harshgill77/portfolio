  ...
  const socialLinks = [
    {
      name: 'Gmail',
      icon: GmailIcon,
      url: 'mailto:harshgill7994@gmail.com',
      color: '#EA4335'
    },
    {
      name: 'Instagram',
    ...
    },
    {
      name: 'WhatsApp',
      icon: WhatsAppIcon,
      url: 'https://wa.me/919779089667',
      color: '#25D366'
    },
    {
      name: 'X',
      icon: XIcon,
      url: 'https://x.com/Gill9720',
      color: '#000000'
    },
    {
      name: 'LinkedIn',
      icon: LinkedInIcon,
      url: 'https://linkedin.com/in/harshpreet-singh-986187287',
      color: '#0077B5'
    },
    {
      name: 'GitHub',
      icon: GitHubIcon,
      url: 'https://github.com/Harshgill77',
      color: '#181717'
    }
  ];
    ...
    <section className="contact section" id="contact">
      <div className="container">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="social-icons-container">
